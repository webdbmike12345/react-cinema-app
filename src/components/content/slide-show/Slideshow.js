...
const Slideshow = (props) => {
  ...
  const moveSlidersWithArrows = (type) => {
  ...
  const RenderArrows = () => {
    return (
      <div className="slider-arrows">
        <div className="slider-arrow slider-arrow--left" onClick={() => moveSlidersWithArrows('prev')}></div>
        <div className="slider-arrow slider-arrow--right" onClick={() => moveSlidersWithArrows('next')}></div>
      </div>
    );
  };
